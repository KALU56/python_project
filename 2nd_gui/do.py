...
import re
import  r_do  # Ensure this file contains the necessary function
...
def schedule_appointment():
    def submit_appointment():
        ...
        if not donor_id:
            ...
            r_do.register()  # Trigger donor registration
...
def register_donor():
    r_do.register_donor()  # Call donor registration window from register_gui
